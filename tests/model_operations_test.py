...
from src.model_operations import load_model, generate_tokens

model = ModelMock()
prompt = """{"user_prompt": "Tell me a joke", "system_context": "You are a funny friend.", "assistant_context": "Be funny.", "max_tokens" : 1000}"""
